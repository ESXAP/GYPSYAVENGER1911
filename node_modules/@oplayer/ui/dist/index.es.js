...
import { $, isMobile, isSafari, isIOS, mergeDeep } from "@oplayer/core";
...
function registerSpeedSetting(it) {
  ...
  if (speeds == null ? void 0 : speeds.length) {
    setting2.register({
      key: KEY,
      type: "selector",
...
const renderMenubar = (it) => {
  ...
  function clickHandler(e) {
    ...
    if (elm.tagName.toUpperCase() == "SPAN") {
      _select(elm);
      (_a2 = target.onChange) == null ? void 0 : _a2.call(target, target.children[+elm.getAttribute("data-index")], elm.parentElement.previousElementSibling);
    } else if (elm.tagName.toUpperCase() == "BUTTON") {
      (_b = target.onClick) == null ? void 0 : _b.call(target, elm);
    }
  }
  $targets.forEach((it2) => {
